...
export const PLATE_W = 224;    // one person plate (avatar + name + dates·age)
...
export const CHILD_PW = 224;   // portrait child plate width — MUST match PLATE_W;
                                // ChartTree always renders a plate at PLATE_W
                                // regardless of ancestor/child role, so this stays
                                // in lockstep or child-row connectors drift (see
