...
function gedcomName(p) {
  ...
  // short display_name) lost their middle name from every export. Guarded
  // against duplicating it, since a re-exported person's given_names may
  // already have absorbed it on a prior import.
